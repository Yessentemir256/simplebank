...
// Source: github.com/Yessentemir256/simplebank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) GetAccoutForUpdate(ctx context.Context, id int64) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccoutForUpdate", ctx, id)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetAccoutForUpdate(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccoutForUpdate", reflect.TypeOf((*MockStore)(nil).GetAccoutForUpdate), ctx, id)
}
